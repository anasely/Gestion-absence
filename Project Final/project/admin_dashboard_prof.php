        ...
        <div class="row vh-100">
            <div class="col-md-3 leftSide">
                ...
                <div class="items">
                    <div class="item text-center mt-3 d-flex align-items-startr">
                        ...
                        <span class="ml-3"><a class="text-white" href="./admin_statistique.php">Statistique</a></span>
                    </div>
                    <div class="item text-center mt-3 d-flex align-items-startr">
                        <img src="./images/dashboard-white.png" alt="dashboard" />
                    ...
                    <div class="item-selected text-center mt-3 d-flex align-items-start">
                        ...
                        <span class="ml-3"><a class="" href="./admin_Dashboard_prof.php">Gestion des
                                professeur</a></span>
                    </div>
            ...
            <div class="col-md-9">
                ...
                <table class="table mt-4">
                    ...
                    foreach ($studentData as $prof) {
                        echo "<tr>";
                        echo "<td>" . $prof["id"] . "</td>";

                        echo "<td>" . $prof["nom"] . "</td>";
                        echo "<td>" . $prof["login"] . "</td>";
                        echo "<td>" . $prof["password"] . "</td>";
                        echo '<td>
            <a href="deleteProf.php?prof_id=' . $prof["id"] . '" class="btn btn-danger">supprimer</a>
        </td>';
                        echo "</tr>";
                    }
                    ?>
