      ...
      <div class="col-md-3 leftSide">
        ...
        <div class="items mt-5">
          <div class="item text-center d-flex align-items-start">
            ...
            <span class="ml-3"><a class="text-white" href="./ProfDashboard.php">Les etudiants absents</a></span>
          </div>

          <div class="item-selected text-center mt-3 d-flex align-items-start">
            <img src="./images/chat-blue.png" alt="dashboard" />
            <span class="ml-3"><a class="" href="./ProfChat.php">Chat</a></span>
          </div>
    ...
    $(document).ready(function () {
      ...
      function sendMessage() {
        ...
        $.ajax({
          ...
          data: {
            message: message,
            receiver_id: '52dba25f', // Replace with the receiver's ID
          },
          ...
          success: function (response) {
            ...
            response.forEach(function (message) {
              ...
              if (message.sender_id == <?php echo $_SESSION['user_id']; ?>) {
                ...
                formattedMessage = "Etudiant: " + message.message;
              }
